  ...
  return (
    <main className="min-h-screen relative bg-black selection:bg-primary selection:text-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-neutral-900/50 via-black to-black" />
        <div className="absolute top-0 left-0 right-0 h-[500px] bg-linear-to-b from-primary/10 to-transparent opacity-30 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <h1 className="font-serif text-5xl md:text-8xl lg:text-9xl font-black text-white tracking-tight mb-8 leading-tight max-w-6xl mx-auto">
          UNFORGETTABLE
          <span className="block text-transparent bg-clip-text bg-linear-to-r from-white via-white/50 to-transparent italic font-light">
            Luxury.
          </span>
        </h1>
