...
import { UpdateRoomSchema, UpdateRoomInput } from '@/lib/schemas/hotel.schema';
import {
  Form,
  FormControl,
  FormField,
...
import { useUpdateRoom, useAmenities } from '@/hooks/useHotels';
...
export default function EditRoomForm({ hotelId, room }: EditRoomFormProps) {
  const { mutate: updateRoom, isPending } = useUpdateRoom(hotelId, room.id);
